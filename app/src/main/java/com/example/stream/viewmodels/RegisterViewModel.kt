...
import com.example.stream.util.Constant.USER_COLLECTION
import com.example.stream.util.RegisterFieldState
...
import com.example.stream.util.validateName
import com.example.stream.util.validatePassword
...
class RegisterViewModel @Inject constructor(
    ...
    private fun checkValidation(user: User, password: String): Boolean {
        ...
        val nameValidation = validateName(user.firstName, user.lastName)
